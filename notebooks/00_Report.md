...
Also It has been found a technical error on `quarter` variable. It
...
- Accuracy: The overall accuracy of the model, which is calculated as
...
Thanks to multiple linear regression we can see influential variables
